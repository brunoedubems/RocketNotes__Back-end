...
const sqliteConnection = require('../database/sqlite').default;
...
const user = await database.get("SELECT * FROM users WHERE id = ( ? )", [ user_id]); //seleciona os dados do id requerido no banco de dados,
